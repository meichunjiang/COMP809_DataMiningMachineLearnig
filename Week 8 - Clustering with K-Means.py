'''
COMP809 – Data Mining and Machine Learning Lab 8 – Clustering with K-Means

This lab will cover K-Means clustering.
This is an additional example for you to getting familiar with k-means clustering with different cluster configurations.
